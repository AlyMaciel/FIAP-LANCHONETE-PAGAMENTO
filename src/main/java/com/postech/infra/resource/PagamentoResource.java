...
public interface PagamentoResource {
    ...
    @ApiResponses(value = {
            @ApiResponse(description = "Pagamento criado com sucesso", responseCode = "201", content = @Content(mediaType = "application/json", schema = @Schema(implementation = CriarPagamentoRequestDTO.class))),
    ...
    ResponseEntity<Object> criarPagamento(@RequestBody CriarPagamentoRequestDTO criarPagamentoRequestDTO);
